class Cxmsg {
  ...
  static mostrar = (config, titulo, texto) => {
    ...
    const rodapCxmsg = document.createElement("div")
    rodapCxmsg.setAttribute("style", estilo_rodapeCxmsg)
    areaCxmsg.appendChild(rodapCxmsg)
    ...
    if (this.tipo == "ok") {
      ...
      rodapCxmsg.appendChild(btn_sim)
      ...
      rodapCxmsg.appendChild(btn_nao)
    }
  }
