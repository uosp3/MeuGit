...
class DispathcLoginRequiredMixin(View):
...
class Pagar(DispathcLoginRequiredMixin, DetailView):
...
class Detalhe(DispathcLoginRequiredMixin, DetailView):
    model = Pedido
    context_object_name = 'pedido'
...
class Lista(DispathcLoginRequiredMixin, ListView):
    model = Pedido
