...
def empresa(request, id):
    ...
    if request.method == 'GET':
        ...
        return render(request, 'empresa.html', {'empresa': empresa, 'documentos': documentos, 'proposta_envestimentos_enviadas': propostas_investimentos_enviada, 'percentual_vendido': int(percentual_vendido), 'total_captado': total_captado, 'valuation_atual': valuation_atual})
